			...
			<div id="member-container">
				...
				<div class="member-card">
					<div class="card">
						<div class="front">
							<div class="cover">
								<img src="img/members/card1.png">
							</div>
							<div class="user">
								<img class="img-circle" src="img/members/jim.png">
							</div>
							<div class="content">
								<div class="main">
									<h3>Jim Andersson</h3>
									<p class="profession">Bilmekaniker</p>
									<h5><i class="fa fa-map-marker fa-fw"></i> Tingsryd, Sverige</h5>
									<h5><i class="fa fa-building-o fa-fw"></i> Carlqvist Bil AB</h5>
									<h5><i class="fa fa-envelope-o fa-fw"></i> <a href="mailto:jimandersson@totalextas.se" target="_blank">jimandersson@totalextas.se</a></h5>
								</div>
								<div class="footer">
